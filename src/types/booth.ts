...
export const boothColorSchema = z.enum([
  "red", "blue", "yellow_green", "green", "purple", "orange", "random"
]);
export type BoothColor = z.infer<typeof boothColorSchema>;


export const placeIdSchema = z.enum([
  "gym1", "m1a/m1b", "m2a/m2b/m2c/m2d", "h3a", "h3b", "h3c", "h3d", "ground", "sp3", "h2b/h2c", "m3c", "m3d", "spj4", "science", "catholic", "theater", "biology", "h2d", "sp2", "h1c/h1d", "tech", "sp5", "h2a", "sp4", "physics", "h3e", "music", "large/sp1", "m3b", "?", "sp6", "gym2", "m1c/m1d", "meeting", "shodo", "m3a"
]);
